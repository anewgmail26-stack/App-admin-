...
The profile form saves the new fields requested for profile-wise server management while keeping the earlier pack fields (`profile_name`, `country_network`, `payload`, and related settings) for compatibility.
